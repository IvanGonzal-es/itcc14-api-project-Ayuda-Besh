...
admin_data = {
    ...
    "phone": "+63 912 345 6789",  # Added phone number
...
admin_document = {
    ...
    "phone": admin_data.get("phone", "+63 912 345 6789"),  # Include phone
...
compass_doc = {
    ...
    "phone": admin_document.get("phone", "+63 912 345 6789"),
...
print(f'  phone: "{admin_document.get("phone", "+63 912 345 6789")}",')
